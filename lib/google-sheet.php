...
if (!defined('GOOGLE_SHEET_PARENTS_SPREADSHEET_NAME')) 
    define('GOOGLE_SHEET_PARENTS_SPREADSHEET_NAME', 'W2C3 - Student List - PLEASE DO NOT ADD DIRECTLY TO THE GOOGLE_SHEET - USE THE FORM INSTEAD');
...
function google_sheet_get_worksheet_columns($sheetName, $worksheetName) {
